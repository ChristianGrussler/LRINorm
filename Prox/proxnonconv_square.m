...
%   where p=2 or p=inf.
%  
%   [...] = PROXNONCONV_SQUARE(Z,r,p,gamma,option) allows us to specify furhter options:
%       1. [...] = PROXNONCONV_SQUARE(Z,r,p,gamma,...,'vec') is used to flag that the
%       vector-valued problem is to be solved.
%       2. [...] = PROXNONCONV_SQUARE(Z,r,p,gamma,...,'tol',tol) sets the relative
...
%%%%%%%%%%%%%
function X = proxnonconv_square(Z,r,p,gamma,varargin)
...
X = proxnormrast_square(Z,r,p,gamma,varargin);
